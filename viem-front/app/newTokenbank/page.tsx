...
const TOKEN_BANK_ADDRESS = '0x5FbDB2315678afecb367f032d93F642f64180aa3' as Address;
const ERC20_TOKEN_ADDRESS = '0x9fE46736679d2D9a65F0992F2272dE9f3c7fa6e0' as Address;
    ...
    <div className="flex min-h-screen flex-col items-center justify-center p-24">
      ...
      <div className="w-full max-w-md space-y-6">
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          <p className="mb-2">TokenBank 存款: {formatEther(depositBalance || BigInt(0))} MTK Token</p>
          <p className="mb-4">当前授权额度: {formatEther(allowance)} MTK</p>
        </div>
